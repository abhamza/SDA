...
{\small
\begin{tabular}{lcl}
E-mail & : & \url{p.geurts@ulg.ac.be}\\
URL    & : & \url{http://www.montefiore.ulg.ac.be/~geurts/sda.html}\\
...
%\input{01-intro.tex}
%\input{02-analyse.tex}
\input{03-tri.tex}
\input{04-structures_elementaires.tex}
%\input{05-dictionnaires.tex}
%\input{06-resolution.tex}
%\input{07-graphes.tex}
