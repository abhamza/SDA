...
\note{Cuckoo hashing: on utilise plusieurs fonctions de hachage: si collision, on déplace l'élément à une nouvelle position en utilisant la fonction de hachage. Si re-collision, on prend la suivante, et ainsi de suite. Recherche: on utilise les fonctions de hachages en séquence.
